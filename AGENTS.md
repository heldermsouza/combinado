...
Este arquivo é o **contrato de trabalho** entre eu (Helder, founder/tech lead) e o Codex. Toda sessão começa lendo isto. Se algo aqui está desatualizado, atualize antes de codar.
...
- **Anthropic Codex Haiku** para categorização (fallback OpenAI GPT-4o-mini) — API direta
...
- [ ] RF04 — registro por texto com Codex Haiku
...
- ❌ **Não permitir** que Codex envie mensagens em nome do Helder (WhatsApp, email) — só rascunhos no chat pra ele revisar e mandar
...
## 12. Como o Codex deve trabalhar comigo
